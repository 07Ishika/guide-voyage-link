...
const sampleData = {
  users: [
    ...
    },
    {
      ...
      photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=priyaguide',
      role: 'guide',
      createdAt: new Date(),
      updatedAt: new Date()
    },
  ...
  profiles: [
    ...
    {
      userId: 'user_4', // Will be updated with actual ObjectId
      fullName: 'Priya Sharma',
      email: 'priya.guide@example.com',
      ...
      professionalLicenses: ['Immigration Consultant License - ICCRC'],
      verificationDocuments: ['Passport', 'Professional License'],
      verifiedStatus: 'verified',
      verificationDate: new Date(),
      expertiseAreas: ['Express Entry', 'Job Search', 'Student Visas'],
      consultationTypes: ['Initial Assessment', 'Document Review'],
      remoteConsultation: true,
    ...
    {
      userId: 'user_5', // Will be updated with actual ObjectId
      fullName: 'Rahul Mehta',
      email: 'rahul@example.com',
      bio: 'German immigration expert with extensive experience in EU Blue Card applications',
      ...
      hourlyRate: 45,
      availability: 'Available',
      citizenshipCountry: 'Germany',
      residenceCountry: 'Germany',
      targetCountries: ['Germany'],
      professionalLicenses: ['German Immigration Consultant License'],
      verificationDocuments: ['Passport', 'Professional License'],
      verifiedStatus: 'verified',
      verificationDate: new Date(),
      expertiseAreas: ['German Language', 'Startup Visa', 'Work Permits'],
      consultationTypes: ['Initial Assessment', 'Language Requirements'],
      remoteConsultation: true,
      inPersonConsultation: true,
      emergencySupport: true,
      rating: 4.8,
    ...
    {
      userId: 'user_6', // Will be updated with actual ObjectId
      fullName: 'Anita Patel',
      email: 'anita@example.com',
      bio: 'Australian migration specialist helping skilled professionals relocate',
      ...
      professionalLicenses: ['Australian Migration Agent License'],
      verificationDocuments: ['Passport', 'Professional License'],
      verifiedStatus: 'verified',
      verificationDate: new Date(),
      expertiseAreas: ['Healthcare Visa', 'Family Visa', 'Skilled Migration'],
      consultationTypes: ['Initial Assessment', 'Skills Assessment'],
      remoteConsultation: true,
      inPersonConsultation: false,
